...
resource "google_monitoring_alert_policy" "alert-policy-email" {
  ...
  notification_channels = [
    "${google_monitoring_notification_channel.notification-email.id}",
  ]
}
...
resource "google_monitoring_alert_policy" "alert-policy-webhook" {
  ...
  notification_channels = [
    "${google_monitoring_notification_channel.notification-webhook.id}",
  ]
}
...
resource "google_monitoring_alert_policy" "alert-policy-pagerduty" {
  ...
  notification_channels = [
    "${google_monitoring_notification_channel.notification-pagerduty.id}",
  ]
}
